<?php
/**
 * karaoke functions and definitions.
 *
...
function karaoke_setup() {
	 ...
	 * If you're building a theme based on karaoke, use a find and replace
	 * to change 'karaoke' to the name of your theme in all the template files.
	 */
	load_theme_textdomain( 'karaoke', get_template_directory() . '/languages' );
 ...
 */
function karaoke_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'karaoke_content_width', 640 );
}
add_action( 'after_setup_theme', 'karaoke_content_width', 0 );
 ...
 */
function karaoke_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'karaoke' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'karaoke' ),
...
add_action( 'widgets_init', 'karaoke_widgets_init' );
